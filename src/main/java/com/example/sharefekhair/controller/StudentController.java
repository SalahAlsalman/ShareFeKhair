...
public class StudentController {
    ...
    @PostMapping
    public ResponseEntity<ResponseAPI<?>> addStudentToClass(
            @RequestParam Integer student_id,@RequestParam Integer class_id){
        studentService.addStudentToClass(student_id,class_id);
